...
var _reactExifOrientationImg = require('react-exif-orientation-img');

var _reactExifOrientationImg2 = _interopRequireDefault(_reactExifOrientationImg);
    ...
    value: function renderPreviewPictures() {
      ...
      return this.state.pictures.map(function (picture, index) {
        return _react2.default.createElement(
          ...
          _react2.default.createElement(_reactExifOrientationImg2.default, {
            src: URL.createObjectURL(_this5.toBlob(picture)),
